function [OptChc,Result,TotFlow,T,ErrRate]=SSTNDP_Exp1_Grid(M,Run,policy,nReqRoute,maxL,PreDefTruth,GridInput,a,b)

PUMAinfo=GridInput(a,b).FlowInfo;
TrCorrCov=GridInput(a,b).CovMat;
TrCorrMean=GridInput(a,b).CorrMeanStd;
TrUncorr=GridInput(a,b).UncorrMeanStd;
PilotPre=GridInput(a,b).Pilot;
nOD=GridInput(a,b).nFlow;
nNode=GridInput(a,b).nNode;
ReachableNodes=GridInput(a,b).ReachableNodes;
FlowCluster=GridInput(a,b).FlowCluster;
EdgeInfo=PreDefTruth.LinkInfo;
...
%% VERIFY IF USING APPROPRIATE POLICY
